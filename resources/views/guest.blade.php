...
@section('container')
  ...
  <div class="home-footer">
    ...
    <div class="social-media">
      <a class="social-media-icon" href="https://www.facebook.com/"><img src="{{ asset('assets/Home/facebook.png') }}" alt="Facebook"></a>
      <a class="social-media-icon" href="https://www.instagram.com/"><img src="{{ asset('assets/Home/instagram.png') }}" alt="Instagram"></a>
      <a class="social-media-icon" href="https://www.linkedin.com/"><img src="{{ asset('assets/Home/linkedin.png') }}" alt="LinkedIn"></a>
      <a class="social-media-icon" href="https://www.google.com/gmail/about/"><img src="{{ asset('assets/Home/gmail.png') }}" alt="Gmail"></a>
    </div>
